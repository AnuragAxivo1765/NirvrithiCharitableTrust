  ...
  <div class="footer__inner container">
    ...
    <div class="footer__col">
      ...
      <address class="footer__contact" aria-label="Organisation contact details">
        ...
        <div class="footer__contact-item">
          ...
          <span>
            Pookoya Thangal Hospice<br>
            Mannancherry, Alapuzha<br>
            Kerala <!-- [PLACEHOLDER: Full postal address] -->
          </span>
        </div>

        <div class="footer__contact-item">
          <svg class="footer__icon" aria-hidden="true" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
            <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12 19.79 19.79 0 0 1 1.61 3.43 2 2 0 0 1 3.6 1.27h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.91a16 16 0 0 0 5.86 5.86l.91-.92a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21.27 16z"/><!-- [PLACEHOLDER: Phone number] -->
          </svg>
          <!-- PLACEHOLDER: Replace with actual phone number -->
          <a href="tel:+910000000000" class="footer__link">[Phone Number Placeholder]</a>
        </div>
        ...
        <div class="footer__contact-item">
          ...
          <a href="mailto:info@nirvruthitrust.org" class="footer__link">[Email Placeholder]</a>
        </div>
    ...
    <div class="footer__col">
      ...
      <div class="footer__social">
        <!-- PLACEHOLDER: Replace href="#" with actual Facebook page URL -->
        ...
        <!-- PLACEHOLDER: Replace href="#" with actual Instagram profile URL -->
        ...
        <!-- PLACEHOLDER: Replace href="#" with actual YouTube channel URL -->
      ...
      <div class="footer__hours">
        ...
        <!-- PLACEHOLDER: Replace with actual contact/office hours -->
        <p>[Contact hours placeholder]<br>e.g., Mon–Sat, 9 AM – 5 PM</p>
      </div>
    </div>
